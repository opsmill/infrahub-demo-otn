...
network. Only eight sections carry a wavelength, so thirteen of the twenty-one
were never evaluated by anything. Paris to Madrid was one of the thirteen. The
