...
Thirteen of the twenty-one sections carry no wavelength at all. That is the real
...
a broken render. Thirteen of the twenty-one sections carry no wavelength at all, so
